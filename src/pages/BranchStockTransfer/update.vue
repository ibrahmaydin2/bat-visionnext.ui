          ...
          <b-row>
            <b-col cols="12" md="3">
              <b-form-group :label="$t('insert.BranchStockTransfer.ItemCode')">
                <v-select :options="items" @search="onItemsSearch" @input="selectedItem" label="Description1"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3">
...
export default {
  ...
  methods: {
    ...
    getData () {
      this.$store.dispatch('getData', {...this.query, api: `VisionNextBranch/api/${this.routeName}`, record: this.$route.params.url})
    },
