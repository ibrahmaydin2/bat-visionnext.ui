        ...
        <b-tab :title="$t('insert.vehicles.additionalInfo')">
          <b-row class="p-4">
            ...
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.Category1, 'object', 'insert.vehicles.SAASvehicleCategory1')"></div>
              <div v-html="getFormatDataByType(rowData.Category2, 'object', 'insert.vehicles.SAASvehicleCategory2')"></div>
              <div v-html="getFormatDataByType(rowData.Category3, 'object', 'insert.vehicles.SAASvehicleCategory3')"></div>
