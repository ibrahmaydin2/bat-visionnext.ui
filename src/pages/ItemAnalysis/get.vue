  ...
  <div class="asc__showPage">
    ...
    <div class="asc__showPage-container">
      ...
      <b-tabs>
        ...
        <b-tab lazy :title="$t('insert.itemAnalysis.validDates')" v-if="rowData.ValidityType && rowData.ValidityType.Code === 'SS'">
           <b-row>
            <b-col>
              <b-card class="m-3 asc__showPage-card">
        ...
        <b-tab lazy :title="$t('insert.itemAnalysis.customerList')" v-if="rowData.CustomerCriteria && rowData.CustomerCriteria.Code === 'ML'">
           <b-row>
            <b-col>
              <b-card class="m-3 asc__showPage-card">
        ...
        <b-tab lazy :title="$t('insert.itemAnalysis.customerCriterias')" v-if="rowData.CustomerCriteria && rowData.CustomerCriteria.Code === 'MK'">
           <b-row>
            <b-col>
              <b-card class="m-3 asc__showPage-card">
