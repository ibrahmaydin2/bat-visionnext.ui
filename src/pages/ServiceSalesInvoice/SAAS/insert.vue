      ...
      <b-tabs>
        <b-tab :title="$t('insert.order.enterInvoice')" active @click.prevent="tabValidation()">
          <b-row>
            ...
            <NextFormGroup item-key="Description1" :error="$v.form.Description1" md="2" lg="2" :required="false">
        ...
        <b-tab :title="$t('insert.order.enterProducts')" @click.prevent="tabValidation()" v-if="form.CustomerId > 0">
          <b-row>
            ...
            <NextFormGroup :title="$t('insert.order.totalItemDiscount')" :error="$v.selectedInvoiceLine.totalItemDiscount" :required="true" md="2" lg="2">
              <NextInput type="number" v-model="selectedInvoiceLine.totalItemDiscount" disabled />
            </NextFormGroup>
  ...
  methods: {
    ...
    addInvoiceLine () {
      ...
      let order = {
        ...
        TotalItemDiscount: this.selectedInvoiceLine.totalItemDiscount,
        TotalOtherDiscount: 0,
