        ...
        <b-tab :title="$t('insert.warehouse.Warehouse')" :active="true" @click.prevent="tabValidation()">
          <b-row>
            ...
            <NextFormGroup item-key="IsVirtualWarehouse" :error="$v.form.IsVirtualWarehouse" md="3" lg="3">
              <NextCheckBox v-model="form.IsVirtualWarehouse" type="number" toggle :disabled="insertReadonly.IsVirtualWarehouse" />
            </NextFormGroup>
            ...
            <NextFormGroup item-key="WarehouseCapacity" :error="$v.form.WarehouseCapacity" md="3" lg="3">
              <NextInput type="text" v-model="form.WarehouseCapacity" :disabled="insertReadonly.WarehouseCapacity"></NextInput>
            </NextFormGroup>
