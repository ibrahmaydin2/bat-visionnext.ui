        ...
        <b-tab :title="$t('insert.order.title')" active>
          <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.PriceList, 'object', 'insert.order.pricecumentNumber')"></div>
              <div v-html="getFormatDataByType(rowData.Description1, 'text', 'insert.order.descList')"></div>
            </b-card>
             <b-card class="col-md-6 col-12 asc__showPage-card">
              <div v-html="getFormatDataByType(rowData.DocumentNumber, 'text', 'insert.order.description1')"></div>
