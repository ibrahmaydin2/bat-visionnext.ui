      ...
      <b-row>
        <b-col cols="12">
          <section>
            ...
            <span><i class="far fa-circle" />  <b>{{$t('insert.cancelReason.cardType')}}:</b> {{rowData.CardType ? rowData.CardType.Label : ''}}</span>
          </section>
        </b-col>
      </b-row>
    </div>
...
export default {
  ...
  methods: {
    ...
    getData () {
      this.$store.dispatch('getData', {...this.query, api: 'VisionNextCommonApi/api/CancelReason', record: this.$route.params.url})
    }
  }
}
</script>
