  ...
  turnoverPremiumItems: [
    {
      ...
      labelProperty: 'Prim',
      url: 'VisionNextContract/api/ContractEndorsement/SearchEndorsement',
  ...
  contractCashItems: [
    {
      ...
      url: 'VisionNextContract/api/Contract/SearchPaymentPlan',
  ...
  tprItems: [
    {
      ...
      url: 'VisionNextContract/api/Contract/SearchTempPriceRed',
