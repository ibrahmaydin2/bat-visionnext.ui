        ...
        <b-tab :title="$t('insert.creditcard.CreditCard')" active>
           <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
                ...
                <span><i class="far fa-circle" /> {{$t('get.CreditCard.PaymentDate')}}</span> <p>{{rowData.PaymentDate}}</p>
                <span><i class="far fa-circle" /> {{$t('get.CreditCard.CashTotal')}}</span> <p>{{rowData.CashTotal}}</p>
            </b-card>
            <b-card class="col-md-6 col-12 asc__showPage-card">
                ...
                <span><i class="far fa-circle" /> {{$t('get.CreditCard.CashCardTypeId')}}</span> <p>{{rowData.CashCardType && rowData.CashCardType.Label}}</p>
            </b-card>
          </b-row>
        </b-tab>
      </b-tabs>
