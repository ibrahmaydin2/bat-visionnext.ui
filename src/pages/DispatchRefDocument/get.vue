        ...
        <b-tab :title="$t('insert.order.enterWaybill')" active>
          <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.ActualyDeliveryTime ? rowData.ActualyDeliveryTime : new Date().toTimeString().slice(0, 5), 'text', 'insert.order.actualDeliveryTime')"></div>
