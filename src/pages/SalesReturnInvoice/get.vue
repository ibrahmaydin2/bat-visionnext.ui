          ...
          <b-row>
            <b-col cols="12" md="12">
              <b-card class="m-4 asc__showPage-card">
                <NextExportDetail
                  url="VisionNextInvoice/api/SalesReturnInvoice/ExcelExportItems"
...
export default {
  ...
  methods: {
    ...
    getData () {
      this.$store.dispatch('getData', {...this.query, api: 'VisionNextInvoice/api/SalesReturnInvoice', record: this.$route.params.url})
    }
  }
}
</script>
