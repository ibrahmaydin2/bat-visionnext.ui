<template>
  <b-modal id="sales-maximum-excel-modal" :title="$t('insert.creditBudget.excelImport')" size="lg" hide-footer no-close-on-backdrop>
    <div class="container">
      <b-row>
        <template>
          <b-form-file
...
export default {
  ...
  methods: {
    ...
    closeModal () {
      this.$root.$emit('bv::hide::modal', 'sales-maximum-excel-modal')
    }
