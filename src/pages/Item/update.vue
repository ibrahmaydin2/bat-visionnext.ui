<template>
  <b-row>
    ...
    <b-col cols="12" class="asc__updatePage-content-head">
      <section>
        <b-row>
           <b-col cols="12" md="2">
            <b-form-group
              :label="$t('update.item.Model_Code')"
            >
              <b-form-input type="text" v-model="form.Code" />
            </b-form-group>
          </b-col>
          <b-col cols="12" md="2">
            <b-form-group :label="$t('update.item.Model_Description1')">
              <b-form-input type="text" v-model="form.Description1" />
            </b-form-group>
          </b-col>
          <b-col cols="12" md="2">
            <b-form-group
              :label="$t('update.item.Model_CardTypeId')"
            >
    ...
    <b-col cols="12">
      <b-tabs>
        <b-tab :title="$t('update.item.detail')" active>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_ShortDescription')">
                <b-form-input type="text" v-model="form.ShortDescription" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_ExportDescription1')">
                <b-form-input type="text" v-model="form.ExportDescription1" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_ProducerCodeId')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_TimeFrameId')">
                <v-select :options="form.TimeFrameId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_IsBarterAllowed')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_CategoryId')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_SortOrder')">
                <b-form-input type="text" v-model="form.SortOrder" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_ClassId')">
                <v-select :options="form.ClassId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_ColorId')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_IsOrderAllowed')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_IsSaleAllowed')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_UseSalesAnalysis')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_IsSpGiftItem')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_IsPhysicalBom')">
        ...
        <b-tab :title="$t('update.item.ItemFinancialInfo')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.ItemInsertModel')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_KindId')">
                <v-select :options="form.ColorId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_UnitSetId')">
                <v-select :options="form.ColorId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_FinanceCode')">
                <b-form-input type="text" v-model="form.FinanceCode" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_DiscountGroup1Id')">
                <v-select :options="form.DiscountGroup1Id" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_RecurrenceTypeId')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_MaxDiscountRate')">
                <b-form-input type="text" v-model="form.MaxDiscountRate" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_Category1Id')">
                <v-select :options="form.Category1Id" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_Category2Id')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_Category9Id')">
                <v-select :options="form.Category9Id" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_Category10Id')">
                <v-select :options="form.Category10Id" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
          </b-row>
        </b-tab>
        <b-tab :title="$t('update.item.ItemCustomers')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_CustomerId')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_CustomerItemDescription')">
        ...
        <b-tab :title="$t('update.item.ItemBarcodes')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_UnitSetId')">
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_Barcode')">
        ...
        <b-tab :title="$t('update.item.ItemOrderQuotas')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_BeginDate')">
                <b-form-datepicker id="contract-datepicker" :placeholder="$t('update.vehicles.chooseDate')" v-model="form.BeginDate" locale="tr" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_EndDate')">
                <b-form-datepicker id="contract-datepicker" :placeholder="$t('update.vehicles.chooseDate')" v-model="form.EndDate" locale="tr" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_QuotaQuantity')">
                <b-form-input type="text" v-model="form.QuotaQuantity" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_QuotaUnitId')">
                <v-select :options="form.QuotaUnitId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_QuotaBranchId')">
                <v-select :options="form.QuotaBranchId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_QuotaRegionId')">
                <v-select :options="form.QuotaRegionId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_StatusId')">
        ...
        <b-tab :title="$t('update.item.ItemAttachments')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.item.Model_File')">
