      ...
      <section>
        <b-row>
          ...
          <NextFormGroup item-key="CardTypeId" :error="$v.form.CardTypeId">
            <NextDropdown v-model="cardType" :disabled="insertReadonly.CardTypeId" @input="selectedSearchType('CardTypeId', $event)" url="VisionNextCommonApi/api/CancelType/Search" />
          </NextFormGroup>
        </b-row>
      </section>
    </b-col>
