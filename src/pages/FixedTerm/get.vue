      ...
      <b-row>
        <b-col cols="12">
          <section>
            ...
            <span><i class="fas fa-calendar" />  <b>{{$t('insert.fixedTerm.period')}}:</b> {{rowData.Period}}</span>
            <span><i class="fa fa-pencil-alt" />  <b>{{$t('insert.fixedTerm.description1')}}:</b> {{rowData.Description1}}</span>
          </section>
        </b-col>
      </b-row>
    </div>
