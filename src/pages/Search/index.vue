  ...
  <div>
    ...
    >
      ...
      <template #dateCell=" { data }">
        <span>{{ milli2date(data.value) }}</span>
      </template>
  ...
  data () {
    ...
    return {
      ...
      setRows: [
        ...
        { visible: true, align: 'left', format: '', type: '', field: 'CreatedDateTime', cellTemplate: '' },
    ...
    getData (pn) {
      ...
      if (parseInt(this.$route.params.q)) {
        ...
        dataSearchKit = {
          ...
          'OrConditionModels': [
            {
              'PatientName': this.$route.params.q,
              'PatientSurname': this.$route.params.q,
              'SerialNumber': this.$route.params.q
            }]
        }
      }
    ...
    optionSelected (e) {
      switch (e.itemData.id) {
        case 2:
          ...
          break
        case 3:
          this.$router.push({name: 'WorkOrderUpdate', params: {url: this.selectedRowKey}, query: { KitTypeId: this.$route.params.q }})
          break
        case 4:
          this.$router.push({name: 'WorkOrderGet', params: {url: this.selectedRowKey}})
          break
