...
export default {
  ...
  computed: {
    ...mapState(['developmentMode', 'insertHTML', 'insertRules', 'insertVisible', 'insertTitle', 'insertReadonly', 'insertColumnType', 'lookup', 'createCode', 'statementDays', 'distiricts', 'banks', 'currency', 'paymentTypes', 'items', 'customerLabels', 'customerLabelValues', 'rowData', 'customerCardTypes', 'cancelReasons', 'paymentPeriods', 'statementDays', 'cities', 'credits', 'touchpoints', 'touchpoint_types'])
  },
  mounted () {
  ...
  watch: {
    ...
    rowData (e) {
      if (e) {
        ...
        //   if (this.insertColumnType[key] !== undefined && this.insertColumnType[key] === 'Select') {
        //     this.form[key] = value
        //     let model = {
        //       RecordId: value
        //     }
        //     this.selectedSearchType(key, model)
        //     console.log(`v-model="${key}"`)
        //   }
        // }
      }
    }
