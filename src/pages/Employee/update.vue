<template>
  <b-row>
    ...
    <b-col cols="12" class="asc__updatePage-content-head">
      <section>
        <b-row>
           <b-col cols="12" md="2">
            <b-form-group
              :label="$t('update.employee.Model_Code')"
            >
              <b-form-input type="text" v-model="form.Code" />
            </b-form-group>
          </b-col>
          <b-col cols="12" md="2">
            <b-form-group :label="$t('update.employee.Model_Name')">
              <b-form-input type="text" v-model="form.Model_Name" />
            </b-form-group>
          </b-col>
          <b-col cols="12" md="2">
            <b-form-group
              :label="$t('update.employee.Model_Surname')"
            >
    ...
    <b-col cols="12">
      <b-tabs>
        <b-tab :title="$t('update.employee.Employee')" active>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_ERPCustomerCode')">
                <v-select :options="form.Model_ERPCustomerCode" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_ERPSupplierCode')">
                <b-form-input type="text" v-model="form.Model_ERPSupplierCode" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_IsRepresentative')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_SAPSrCode')">
                <b-form-input type="text" v-model="form.Model_SAPSrCode" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_PriceListCategoryId')">
                <v-select :options="form.Model_PriceListCategoryId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Team')">
          ...
          <b-row>
            <b-col cols="12" md="6" lg="4">
              <b-form-group :label="$t('update.employee.Model_Description')">
                <b-form-textarea v-model="form.Model_Description" rows="3" max-rows="6" />
              </b-form-group>
            </b-col>
          </b-row>
        </b-tab>
        <b-tab :title="$t('update.employee.EmployeeCustomer')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_CreateCustomer')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_taxNumber')">
                <b-form-input type="text" v-model="form.Model_taxNumber" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_FinanceCode1')">
        ...
        <b-tab :title="$t('update.employee.Model_Personal')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_BirthDate')">
                <b-form-datepicker :placeholder="$t('update.employee.Model_BirthDate')" v-model="form.Model_BirthDate" locale="tr" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_EmploymentStartDate')">
                <b-form-datepicker :placeholder="$t('update.employee.Model_EmploymentStartDate')" v-model="form.Model_EmploymentStartDate" locale="tr" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_EmploymentEndDate')">
                <b-form-datepicker :placeholder="$t('update.employee.Model_EmploymentEndDate')" v-model="form.Model_EmploymentEndDate" locale="tr" class="mb-2"></b-form-datepicker>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_EducationId')">
                <v-select :options="form.Model_EducationId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Identificationnumber')">
                <b-form-input type="text" v-model="form.Model_Identificationnumber" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_BloodType')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_CoatSize')">
                <v-select :options="form.Model_CoatSize" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_TShirtSize')">
                <v-select :options="form.Model_TShirtSize" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_ClothTrousersSize')">
        ...
        <b-tab :title="$t('update.employee.EmployeeContact')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_GsmNumber')">
                <b-form-input type="text" v-model="form.Model_GsmNumber" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Telephone1')">
                <b-form-input type="text" v-model="form.Model_Telephone1" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Telephone2')">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Email')">
                <b-form-input type="text" v-model="form.Model_Email" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_Fax')">
                <b-form-input type="text" v-model="form.Model_Fax" />
              </b-form-group>
            </b-col>
          </b-row>
        </b-tab>
        <b-tab :title="$t('update.employee.EmployeeDevices')">
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_SerialNumber')">
                <b-form-input type="text" v-model="form.Model_SerialNumber" />
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_DeviceModelId')">
                <v-select :options="form.Model_DeviceModelId" @input="selectedVehicle" label="title"></v-select>
              </b-form-group>
            </b-col>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.employee.Model_DeviceUseAraeId')">
        ...
        <b-tab :title="$t('update.employee.EmployeeBanks')">
          <b-row>
            <b-col cols="12" md="6" lg="4">
              <b-form-group :label="$t('update.employee.Model_BankBranchId')">
        ...
        <b-tab :title="$t('update.employee.EmployeePrefix')">
          <b-row>
            <b-col cols="12" md="6" lg="4">
              <b-form-group :label="$t('update.employee.Model_Prefix')">
