...
export const store = new Vuex.Store({
  ...
  actions: {
    ...
    getDashboard ({ state, commit }, query) {
      ...
      return axios.get(`VisionNextDashboard/api/Dashboard/GetUserDashboards/${userId}`, authHeader)
        .then(res => {
          return res
        })
        .catch(err => {
    ...
    getDashboardReports ({ state, commit }, query) {
      return axios.get(`VisionNextDashboard/api/Dashboard/GetUserGadgets/${query.id}`, authHeader)
        .then(res => {
          return res
        })
        .catch(err => {
    ...
    getDashboardReportDetail ({ state, commit }, query) {
      return axios.get(`VisionNextDashboard/api/Dashboard/GetGadgetDetails/${query.id}`, authHeader)
        .then(res => {
          return res
        })
        .catch(err => {
