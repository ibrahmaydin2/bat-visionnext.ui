<template>
  <b-modal id="customer-target-excel-modal" :title="$t('insert.creditBudget.excelImport')" size="lg" hide-footer no-close-on-backdrop>
    <div class="container">
      <b-row>
        <template>
          <b-form-file
...
export default {
  ...
  methods: {
    ...
    closeModal () {
      this.$root.$emit('bv::hide::modal', 'customer-target-excel-modal')
    }
