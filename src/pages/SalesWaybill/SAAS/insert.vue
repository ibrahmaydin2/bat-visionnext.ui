      ...
      <b-tabs>
        <b-tab :title="$t('insert.order.enterInvoice')" active @click.prevent="tabValidation()">
          <b-row>
            ...
            <NextFormGroup item-key="InvoiceKindId" :error="$v.form.InvoiceKindId" md="2" lg="2">
              <NextDropdown url="VisionNextInvoice/api/InvoiceKind/Search" @input="selectedSearchType('InvoiceKindId', $event)" :disabled="insertReadonly.InvoiceKindId"></NextDropdown>
            </NextFormGroup>
            ...
            <NextFormGroup item-key="RepresentativeId" :error="$v.form.RepresentativeId" md="2" lg="2">
              <NextDropdown @input="selectedSearchType('RepresentativeId', $event)" url="VisionNextEmployee/api/Employee/AutoCompleteSearch" orConditionFields="Code,Description1,Name,Surname" searchable :disabled="insertReadonly.RepresentativeId"/>
            </NextFormGroup>
            <NextFormGroup item-key="DeliveryRepresentativeId" :error="$v.form.DeliveryRepresentativeId" md="2" lg="2">
              <NextDropdown @input="selectedSearchType('DeliveryRepresentativeId', $event)" url="VisionNextEmployee/api/Employee/AutoCompleteSearch" searchable :disabled="insertReadonly.DeliveryRepresentativeId" />
            </NextFormGroup>
            ...
            <NextFormGroup item-key="RouteId" :error="$v.form.RouteId" md="2" lg="2">
              <NextDropdown @input="selectedSearchType('RouteId', $event)" url="VisionNextRoute/api/Route/AutoCompleteSearch" searchable :disabled="insertReadonly.RouteId" />
            </NextFormGroup>
            <NextFormGroup item-key="WarehouseId" :error="$v.form.WarehouseId" md="2" lg="2">
              <NextDropdown @input="selectedSearchType('WarehouseId', $event)" url="VisionNextWarehouse/api/Warehouse/AutoCompleteSearch" searchable :disabled="insertReadonly.WarehouseId" />
            </NextFormGroup>
        ...
        <b-tab :title="$t('insert.order.enterProducts')" @click.prevent="tabValidation()">
          <b-row>
            ...
            <NextFormGroup :title="$t('insert.order.isFreeItem')" md="2" lg="2" :required="true" :error="$v.selectedInvoiceLine.isFreeItem">
              <NextCheckBox v-model="selectedInvoiceLine.isFreeItem" type="number" @input="checkIsFree" radio />
            </NextFormGroup>
            <NextFormGroup :title="$t('insert.order.freeReason')" md="2" lg="2" :required="selectedInvoiceLine.isFreeItem === 1" :error="$v.selectedInvoiceLine.freeReason">
              <NextDropdown
                v-model="selectedInvoiceLine.freeReason"
                url="VisionNextDiscount/api/DiscountReason/Search"
                :disabled="selectedInvoiceLine.isFreeItem !== 1"
        ...
        <b-tab :title="$t('insert.order.logisticCompanies')" @click.prevent="tabValidation()" v-if="selectedBranch.UseEWaybill === 1" :disabled="form.VehicleId > 0">
          <b-row>
  ...
  methods: {
    ...
    addInvoiceLine () {
      ...
      let order = {
        ...
        DiscountNetTotal: 0,
        DiscountQuantity: 0,
        IsFreeItem: this.selectedInvoiceLine.isFreeItem,
        FreeReason: this.selectedInvoiceLine.freeReason,
        FreeReasonId: this.selectedInvoiceLine.freeReason ? this.selectedInvoiceLine.freeReason.RecordId : null
      }
    ...
    checkIsFree (value) {
      if (value !== 1) {
        this.selectedInvoiceLine.freeReason = null
      }
    },
