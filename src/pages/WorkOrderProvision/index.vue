  ...
  data () {
    ...
    return {
      ...
      setRows: [
        ...
        { visible: true, align: 'left', format: '', type: '', field: 'KitType', cellTemplate: '' },
        ...
        { visible: true, align: 'left', format: '', type: '', field: 'PatientGender', cellTemplate: '' },
        ...
        { visible: true, align: 'left', format: '', type: '', field: 'WorkOrderType', cellTemplate: '' }
      ],
      setTableActions: [
