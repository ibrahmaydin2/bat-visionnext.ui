        ...
        <b-tab :title="$t('insert.creditcard.CreditCard')" active>
           <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.BankBranch, 'object', 'get.CreditCard.BankBranchId')"></div>
            ...
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.Representative, 'object', 'get.CreditCard.RepresentativeId')"></div>
              ...
              <div v-html="getFormatDataByType(rowData.CardOwner, 'text', 'get.CreditCard.CardOwner')"></div>
