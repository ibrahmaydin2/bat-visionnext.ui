      ...
      <section>
        <b-row>
          <b-col cols="12" md="3" lg="2">
            <b-form-group
              :label="$t('update.warehouse.Model_Code')"
            >
          ...
          <b-col cols="12" md="3" lg="2">
            <b-form-group
              :label="$t('update.warehouse.Model_Description1')"
            >
          ...
          <b-col cols="12" md="3" lg="2">
            <b-form-group
              :label="$t('update.warehouse.Model_StatusId')"
            >
              <b-form-checkbox v-model="form.StatusId" name="check-button" switch>
                {{(form.checked) ? $t('update.yes'): $t('update.no')}}
              </b-form-checkbox>
            </b-form-group>
          </b-col>
        </b-row>
    ...
    <b-col cols="12">
      <b-tabs>
        <b-tab title="Depo Ana Kayıtları" active>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.warehouse.Model_WarehouseTypeId')">
                <v-select :options="form.drivers" @input="selectedDriver" label="title"></v-select>
              </b-form-group>
            </b-col>
            <!-- <b-col cols="12" md="3" lg="2">
              <b-form-group
                :label="$t('update.warehouse.Model_IsVehicle')"
              >
              <b-form-radio-group v-model="form.IsVehicle">
                  <b-form-radio value="1">{{$t('update.warehouse.vehicles.yes')}}</b-form-radio>
                  <b-form-radio value="0">{{$t('update.warehouse.vehicles.no')}}</b-form-radio>
                </b-form-radio-group>
              </b-form-group>
            </b-col> -->
            <b-col cols="12" md="3" lg="2">
              <b-form-group :label="$t('update.warehouse.Model_VehicleId')">
                <v-select :options="form.drivers" @input="selectedDriver" label="title"></v-select>
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group
                :label="$t('update.warehouse.Model_IsCenterWarehouse')"
              >
              <b-form-radio-group v-model="form.IsVehicle">
          ...
          <b-row>
            <b-col cols="12" md="3" lg="2">
              <b-form-group
                :label="$t('update.warehouse.Model_WarehouseCapacity')"
              >
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group
                :label="$t('update.warehouse.Model_LicenseNumber')"
              >
            ...
            <b-col cols="12" md="3" lg="2">
              <b-form-group
                :label="$t('update.warehouse.Model_FinanceCode')"
              >
