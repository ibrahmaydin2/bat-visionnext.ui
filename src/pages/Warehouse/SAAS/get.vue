        ...
        <b-tab :title="$t('get.Warehouse.title')" :active="true">
          <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
              ...
              <div v-html="getFormatDataByType(rowData.IsCenterWarehouse, 'check', 'get.Warehouse.IsCenterWarehouse')"></div>
              <div v-html="getFormatDataByType(rowData.LicenseNumber, 'text', 'get.Warehouse.LicenseNumber')"></div>
            </b-card>
            <b-card class="col-md-6 col-12 asc__showPage-card">
              <div v-html="getFormatDataByType(rowData.WarehouseType, 'object', 'get.Warehouse.WarehouseTypeId')"></div>
              <div v-html="getFormatDataByType(rowData.WarehouseCapacity, 'text', 'get.Warehouse.WarehouseCapacity')"></div>
