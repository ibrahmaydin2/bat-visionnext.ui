        ...
        <b-tab :title="$t('get.assetLocation.general')" active>
          <b-row class="p-4">
            <b-card class="col-md-6 col-12 asc__showPage-card">
              <div v-html="getFormatDataByType(rowData.Type, 'object', 'get.assetLocation.type')"></div>
              ...
              <div v-html="getFormatDataByType(rowData.Brand, 'object', 'get.assetLocation.brand')"></div>
              <div v-html="getFormatDataByType(rowData.Model, 'object', 'get.assetLocation.model')"></div>
